...
from soundstream.modules.commons.torch_stft import TorchSTFT

# my guess is that the criterion_g's stft losses are being satisfied by the MFD itself
# as we can see that its build upon TorchSTFT 
