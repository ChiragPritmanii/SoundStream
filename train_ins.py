...
from soundstream.dataset.dataset_ins import SoundDataset
...
def get_args():
    ...
    parser.add_argument(
        "--train_data_path", type=str, default="path_to_wavs", help="training data"
    )
    parser.add_argument(
        "--valid_data_path", type=str, default="path_to_val_wavs", help="training data"
    )
...
def main_worker(local_rank, args):
    ...
    train_dataset = SoundDataset(audio_dir=args.train_data_path)
    valid_dataset = SoundDataset(audio_dir=args.valid_data_path)
